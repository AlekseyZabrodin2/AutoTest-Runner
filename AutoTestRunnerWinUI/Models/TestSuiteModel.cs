...
namespace AutoTestRunnerWinUI.Models
{
    public partial class TestSuiteModel : ObservableObject
    {
        ...
        public int? PassStatusTest
        {
            get => _passStatusTest;
            set
            {
                if (value != _passStatusTest)
                {
                    _passStatusTest = value;
                    OnPropertyChanged(nameof(PassStatusTest));
                    OnPropertyChanged(nameof(DisplayPassStatusTest));
                }
            }
        }
        ...
        public int? FailedStatusTest
        {
            get => _failedStatusTest;
            set
            {
                if (value != _failedStatusTest)
                {
                    _failedStatusTest = value;
                    OnPropertyChanged(nameof(FailedStatusTest));
                    OnPropertyChanged(nameof(DisplayFailedStatusTest));
                }
            }
        }
        ...
        public int? SkippedStatusTest
        {
            get => _skippedStatusTest;
            set
            {
                if (value != _skippedStatusTest)
                {
                    _skippedStatusTest = value;
                    OnPropertyChanged(nameof(SkippedStatusTest));
                    OnPropertyChanged(nameof(DisplaySkipStatusTest));
                }
            }
        }

        public string? DisplayPassStatusTest => $"Passed [ {PassStatusTest} ]";

        public string? DisplayFailedStatusTest => $"Failed[ {FailedStatusTest} ]";

        public string? DisplaySkipStatusTest => $"Skipped[ {SkippedStatusTest} ]";
        ...
        [ObservableProperty]
        private Visibility? _visibilityTestResult = Visibility.Collapsed;

        //[ObservableProperty]
        private int _selectedTestsInSuiteCount = 0;

        public int SelectedTestsInSuiteCount
        {
            get => _selectedTestsInSuiteCount;

            set
            {
                if (value != _selectedTestsInSuiteCount)
                {
                    _selectedTestsInSuiteCount = value;
                    OnPropertyChanged(nameof(SelectedTestsInSuiteCount));
                    OnPropertyChanged(nameof(DisplayTestNameAndCounts));
                }
            }
        }

        public string DisplayTestCounts => $"[ {NumberOfTests} ] - ( {SelectedTestsInSuiteCount} )";

        public string DisplayTestNameAndCounts => $"{TestClassNameModel} [ {NumberOfTests} ] - ( {SelectedTestsInSuiteCount} )";
        ...
        public TestSuiteModel(IServiceProvider serviceProvider)
        {
            ...
            TestMethodsModel = new ObservableCollection<TestMethodModel>();
